...
- [Homeoffice Zeiterfassung – Ein Full-Stack-Projekt](#homeoffice-zeiterfassung---ein-full-stack-projekt)
  ...
  * [Datenbank-Migrationen](#datenbank-migrationen)
      - [`dotnet ef migrations add Create_Database -p Homeoffice.DataAccess -s Homeoffice.API -c ApplicationDbContext -o Data/Migrations`](#-dotnet-ef-migrations-add-create-database--p-homeofficedataaccess--s-homeofficeapi--c-applicationdbcontext--o-data-migrations-)
  ...
  * [Das Backend abschließen: Die `Program.cs`](#das-backend-abschlie-en--die--programcs-)
  ...
  * [Das Frontend: Eine moderne Angular-Anwendung](#das-frontend--eine-moderne-angular-anwendung)
    ...
    + [2\. Guards: Die Türsteher der Anwendung](#2--guards--die-t-rsteher-der-anwendung)
